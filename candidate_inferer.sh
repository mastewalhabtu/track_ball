...
do
    ...
    python ball_inferer.py --config-name $m --video-input $v --output ../data/results/ball_tunes_full_thresh0.25/ --confidence-threshold 0.25 --opts MODEL.WEIGHTS $w SOLVER.MAX_ITER $i SOLVER.BASE_LR $l
done
